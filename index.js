...
/*Task 1: counterMaker()
  ...
  // counter 1 is consisting of private variables and cannot be accessed outside of the function where as counter 2 can be accessed from outside when invoked a number. 
  
  2. Which of the two uses a closure? How can you tell?
  Both use closure, the return in both the counters is what basically closes them out. 
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     The best use case for counter 1 would be if you want to just count from 0. Counter 2 would be best used if you pass in a number to the parameter to start the count from there. 
*/
